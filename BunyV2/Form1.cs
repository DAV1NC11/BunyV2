...
namespace BunyV2
{
    public partial class MyForm : Form
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (code == 0)
                {
                    ...
                    client.Subscribe(new string[] { "Pi/LEDStatus","Pi/Sensor/T", "Pi/Sensor/H" }, new byte[] { 0,0,0});
                    //READ LED STATUS
        ...
        {
            txtBroker.Text = "m13.cloudmqtt.com";
            txtPort.Text = "19990";
            txtUser.Text = "";
            txtPass.Text = "";
